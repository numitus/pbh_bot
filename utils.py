...
messages = {
    ...
    EXPIRE_VISA: "В настоящее время все визы типа D продляются до конца пандемии +30 дней."
                 " Обязательным условием является то, что в последний день визы вы находились в Польше."
                 " С продленной визой вы можете вьезжать в польшу, но не можете вьезжать в другие страны ЕС. "
    ...
    CAR_IN_POLAND: "По закону вы можете находится на иностранном авто в ЕС максимум пол-года в год. "
    ...
    IP_CHAT: "Больше информации вы можете найти в чате ИП https://t.me/JDG\_PBH",
    INCUBATOR: "Больше информации вы можете найти в чате инкубаторов https://t.me/joinchat/p47wWwYdO6llOTBi",
    ...
    VISA_FOR_FAMILY: "Если вы имеете основания для визы PBH, то ваши несовершеннолетние дети и жена могут получить такую же как вы визу, с правом работы."
